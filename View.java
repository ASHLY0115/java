...
import javax.swing.SwingConstants;public class View { // View uses Swing framework to display UI to user
 ...
 private JButton bye; public View(String title) {
  ...
  layout.setVerticalGroup(layout.createSequentialGroup()
    ...
    .addComponent(lastnameTextfield).addComponent(lastnameSaveButton).addComponent(bye)));  layout.linkSize(SwingConstants.HORIZONTAL, firstnameSaveButton, lastnameSaveButton);
